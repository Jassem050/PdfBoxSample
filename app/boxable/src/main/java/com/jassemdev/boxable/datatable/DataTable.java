package com.jassemdev.boxable.datatable;

import com.jassemdev.boxable.BaseTable;
import com.jassemdev.boxable.Cell;
import com.jassemdev.boxable.HorizontalAlignment;
import com.jassemdev.boxable.Row;
import com.jassemdev.boxable.Table;
import com.jassemdev.boxable.VerticalAlignment;
import com.jassemdev.boxable.line.LineStyle;
...
public class DataTable {
    ...
    private void setDefaultStyles() {
        ...
        // Header style
        headerCellTemplate.setFillColor(new AWTColor(137, 218, 245));
        headerCellTemplate.setTextColor(AWTColor.BLACK);
        ...
        defaultCellTemplate.setFillColor(new AWTColor(242, 242, 242));
        defaultCellTemplate.setTextColor(AWTColor.BLACK);
