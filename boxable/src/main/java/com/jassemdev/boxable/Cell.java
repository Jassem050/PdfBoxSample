...
import com.jassemdev.boxable.text.WrappingFunction;
...
public class Cell<T extends PDPage> {
     ...
     * </p>
     *
     * @param textColor designated text {@link AWTColor}
     */
     ...
     * </p>
     *
     * @param fillColor Fill {@link AWTColor} for the cell
     */
    public void setFillColor(AWTColor fillColor) {
