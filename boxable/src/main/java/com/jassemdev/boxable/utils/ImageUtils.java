package com.jassemdev.boxable.utils;

import android.graphics.Bitmap;
import android.graphics.BitmapFactory;

import com.jassemdev.boxable.image.Image;
...
public class ImageUtils {
    ...
    public static Image readImage(File imageFile) throws IOException {
        final Bitmap bitmap = BitmapFactory.decodeStream(new FileInputStream(imageFile));
        return new Image(bitmap);
    }

    /**
     * <p>
     * Provide an ability to scale {@link Image} on desired {awt Dimension}
     * </p>
     *
